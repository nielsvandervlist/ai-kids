        ...
        <ul>
            {
                items.map((item, index) => {
                    ...
                    >
                        ...
                        {!nextQuestion &&
                            <Link href={item.name === 'Text Generation' ? '/missions/text-generation' : item.name === 'Coding' ? 'missions/code-quiz' : `missions/${item.id}`} className={'flex justify-between items-center'}>
